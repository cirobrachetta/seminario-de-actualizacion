...
class UserController{
    ...
    public:
        ...
        string getUserRole(int index) const;
};
...
string UserController::getUserRole(int index) const {
    return UserRoletoString(users[index].getUserRole());
}
...
void Menu(UserController& userController, const string& username, ArticlesManager& articlesmanager){
    ...
    string role = userController.getUserRole(userIndex);
